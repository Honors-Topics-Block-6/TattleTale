...
export const ROLE_DEFINITIONS: ReadonlyMap<RoleId, RoleDefinition> = new Map([
  ...
  [RoleId.FIREWALL, { id: RoleId.FIREWALL, team: Team.FRIENDS, displayName: 'Firewall', isBase: false, unique: true, minPlayers: 9 }],
  [RoleId.VENGEFUL, { id: RoleId.VENGEFUL, team: Team.FRIENDS, displayName: 'Vengeful', isBase: false, unique: true, minPlayers: 9 }],
